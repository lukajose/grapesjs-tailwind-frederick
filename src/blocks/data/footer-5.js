  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-foreground-900 tracking-widest text-sm mb-3">CATEGORY ONE</h2>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-foreground-900 tracking-widest text-sm mb-3">CATEGORY TWO</h2>
        <nav class="list-none mb-10">
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">First link</a></li>
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">Second link</a></li>
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">Third link</a></li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-foreground-900 tracking-widest text-sm mb-3">CATEGORY THREE</h2>
        <nav class="list-none mb-10">
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">First link</a></li>
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">Second link</a></li>
          <li><a class="text-foreground-600 hover:text-foreground-800 dark:text-foreground-400 text-sm hover:text-primary-500 cursor-pointer">Third link</a></li>
  ...
  <div class="bg-background-900">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-foreground-900">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-white p-2 bg-primary-500 rounded-full" viewBox="0 0 24 24">
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
        </svg>
        <span class="ml-3 text-xl font-bold">Site name</span>
      </a>
      <p class="text-sm text-foreground-500 sm:ml-6 sm:mt-0 mt-4">© 2024 Site name —<a href="https://twitter.com/_frederickai" rel="noopener noreferrer" class="text-foreground-600 ml-1" target="_blank">@_frederickai</a></p>
