...
<section class="body-font text-foreground-100">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <form data-gjs-type="form" style="margin: 0;">
        <div class="flex w-full md:justify-start justify-center items-end">
          ...
          <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
            <label for="hero-field" class="leading-7 text-sm text-foreground-500">Email</label>
            <input type="text" id="hero-field" name="hero-field" class="w-full bg-background-900 bg-opacity-50 rounded border border-foreground-400 focus:ring-2 focus:ring-primary-200 focus:bg-transparent focus:border-primary-500 text-base outline-none text-foreground-900 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
          </div>
      ...
      <p class="text-sm mt-2 text-foreground-400 mb-8 w-full">Subscribe now</p>
