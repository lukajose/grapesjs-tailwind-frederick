...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">A hero title that describes the business in one sentence.</h1>
      <!-- Replace SUBHERO DESCRIPTION with a detailed description of what the business is about -->
      <p class="mb-8 leading-relaxed">A subhero title that describes a bit more about the business.</p>
      <form style="margin: 0;">
        <div class="flex w-full md:justify-start justify-center items-end">
          ...
          <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
            ...
            <input type="text" id="hero-field" name="hero-field" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:ring-primary-200 focus:bg-transparent focus:border-primary-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
          </div>
