...
export function changeSvgColors(svg, colors) {
    ...
    let updatedSvg = svg.replace(stop1Regex, `<stop stop-color="${colors.stop1}"`);
    updatedSvg = updatedSvg.replace(stop2Regex, `<stop offset="0.73249" stop-color="${colors.stop2}"`);
    updatedSvg = updatedSvg.replace(stop3Regex, `<stop offset="1" stop-color="${colors.stop2}"`);
    updatedSvg = updatedSvg.replace(stop4Regex, `<stop offset="1" stop-color="${colors.stop2}"`);
    return updatedSvg;
}

const svg = `<svg class="logo" width="115" height="102" viewBox="0 0 920 817" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="207" y="136" width="603" height="558" fill="url(#paint0_linear_735_12)"/>
<rect x="120" y="279" width="415" height="415" fill="url(#paint1_linear_735_12)"/>
<defs>
<linearGradient id="paint0_linear_735_12" x1="363" y1="568.5" x2="810" y2="193.491" gradientUnits="userSpaceOnUse">
<stop stop-color="#A87FFF"/>
<stop offset="0.73249" stop-color="#DC8AF9"/>
<stop offset="1" stop-color="#DC8AF9"/>
<stop offset="1" stop-color="#A87FFF"/>
</linearGradient>
<linearGradient id="paint1_linear_735_12" x1="227.363" y1="600.662" x2="554.412" y2="346.762" gradientUnits="userSpaceOnUse">
<stop stop-color="#A87FFF"/>
<stop offset="0.73249" stop-color="#DC8AF9"/>
<stop offset="1" stop-color="#ED9AFA"/>
<stop offset="1" stop-color="#A87FFF"/>
</linearGradient>
</defs>
</svg>
...
export const source = changeSvgColors(svg, themes.frederickBest);
