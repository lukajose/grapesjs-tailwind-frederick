export const source = `
<section class="text-foreground-200 body-font">
  <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    ...
    <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
      ...
      <form data-gjs-type="form" style="margin: 0;">
        <div class="flex w-full justify-center items-end">
          ...
          <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
            <label for="hero-field" class="leading-7 text-sm text-foreground-600">Email</label>
            <input type="text" id="hero-field" name="hero-field" class="w-full bg-background-900 bg-opacity-50 rounded focus:ring-2 focus:ring-primary-200 focus:bg-transparent border border-background-600 focus:border-primary-500 text-base outline-none text-foreground-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
          </div>
      ...
      <p class="text-sm mt-2 text-foreground-500 mb-8 w-full">Subscribe now to our newsletter.</p>
      <div class="flex">
