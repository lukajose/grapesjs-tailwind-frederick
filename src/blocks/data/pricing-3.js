export const source = `
<div class="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 dark:text-gray-400 dark:bg-gray-900">
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8 dark:bg-gray-900 w-full">
    <div class="divide-y divide-gray-200 dark:divide-gray-500 rounded-2xl border border-gray-200 shadow-sm dark:border-gray-500 dark:hover:bg-gray-800 hover:bg-gray-100">
      <div class="p-6 sm:px-8">
        ...
        <p class="mt-2 text-gray-700 dark:text-gray-400">Short description of the plan.</p>
        <!-- Replace $20 with the appropriate price -->
        <p class="mt-2 sm:mt-4">
          <strong class="text-3xl font-bold text-gray-900 sm:text-4xl dark:text-gray-100"> $20 </strong>
      ...
      <div class="p-6 sm:px-8">
        <p class="text-lg font-medium text-gray-900 sm:text-xl dark:text-gray-400">What's included:</p>
        <ul class="mt-2 space-y-2 sm:mt-4">
          ...
          <li class="flex items-center gap-1">
            ...
            <span class="text-gray-700 dark:text-gray-300"> Community access </span>
          </li>
        </ul>
      </div>
    </div>
    <div class="divide-y divide-gray-200 dark:divide-gray-500 rounded-2xl border border-gray-200 shadow-sm dark:border-gray-500 dark:hover:bg-gray-800 hover:bg-gray-100">
      <div class="p-6 sm:px-8">
        ...
        <p class="mt-2 sm:mt-4">
          <strong class="text-3xl font-bold text-gray-900 sm:text-4xl dark:text-gray-100"> $120 </strong>
          <span class="text-sm font-medium text-gray-700 dark:text-gray-300">/month</span>
        </p>
        <!-- Replace Get Started with appropriate text for the call to action -->
        <a class="mt-4 block rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 sm:mt-6" href="#">
