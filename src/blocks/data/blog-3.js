      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <a class="inline-flex items-center">
          ...
          <span class="flex-grow flex flex-col pl-4">
            <span class="title-font font-medium text-gray-900">Name of author one</span>
            <span class="text-gray-400 text-xs tracking-widest mt-0.5">JOB TITLE ONE</span>
          </span>
        </a>
      </div>
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <a class="inline-flex items-center">
          ...
          <span class="flex-grow flex flex-col pl-4">
            <span class="title-font font-medium text-gray-900">Name of author two</span>
            <span class="text-gray-400 text-xs tracking-widest mt-0.5">JOB TITLE TWO</span>
          </span>
        </a>
      </div>
    </div>
