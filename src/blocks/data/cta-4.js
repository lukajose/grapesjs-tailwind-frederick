...
<section class="text-foreground-200 body-font">
  <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
    ...
    <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
      ...
      <h1 class="text-foreground-900 text-lg sm:text-2xl mb-1 font-bold title-font">Generate a main headline for this section</h1>
    </div>
    <!-- Call to Action Buttons -->
    <div class="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
      <button class="bg-foreground-900 inline-flex py-3 px-5  rounded-lg items-center hover:bg-foreground-700 focus:outline-none">
        ...
        <button class="bg-foreground-900 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-foreground-700 focus:outline-none">
