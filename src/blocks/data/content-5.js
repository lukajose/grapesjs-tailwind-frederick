  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="md:w-3/5 md:pl-6">
      ...
      <div class="flex md:mt-4 mt-6">
        <button class="inline-flex text-white bg-indigo-500 border-0 py-1 px-4 focus:outline-none hover:bg-indigo-600 rounded">Generate a call-to-action for the button</button>
