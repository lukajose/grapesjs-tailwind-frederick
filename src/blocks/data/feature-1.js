...
<section class="text-foreground-600 body-font dark:bg-gray-900">
  <div class="container px-5  mx-auto">
    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      ...
      <div class="p-4 md:w-1/3 flex">
        <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-primary-100 text-primary-500 mb-4 flex-shrink-0">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6 dark:text-primary-400" viewBox="0 0 24 24">
        ...
        <div class="flex-grow pl-6">
          <h2 class="text-foreground-900 text-lg title-font text-xl font-bold mb-2 dark:text-foreground-900">Generate a feature title</h2>
          <p class="leading-relaxed text-base dark:text-foreground-900 ">Generate a detailed description of the feature, explaining how it benefits the customer. Be concise and to the point.</p>
          <a class="mt-3 text-primary-500 inline-flex items-center dark:text-primary-400">Learn More
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2 dark:text-primary-400" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
