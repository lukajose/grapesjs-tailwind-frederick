...
<footer class="text-foreground-600 body-font">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
      ...
      <p class="mt-2 text-sm text-foreground-500">Small description of your business. </p>
    </div>
  ...
  <div class="bg-background-900">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-foreground-500 text-sm text-center sm:text-left cursor-pointer ">© 2024 Site name —<a href="https://twitter.com/_frederickai" rel="noopener noreferrer" class="text-foreground-600 ml-1 cursor-pointer" target="_blank">@_frederickai</a></p>
